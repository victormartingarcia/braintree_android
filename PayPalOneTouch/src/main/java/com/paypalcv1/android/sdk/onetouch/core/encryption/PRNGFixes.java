package com.paypalcv1.android.sdk.onetouch.core.encryption;
...
final class PRNGFixes {
    ...
    private static void installLinuxPRNGSecureRandom()
        ...
        synchronized (java.security.Security.class) {
            ...
            if (!"LinuxPRNGSecureRandomProvider".equals(rng1.getProvider().getClass().getSimpleName())) {
            ...
            if (!"LinuxPRNGSecureRandomProvider".equals(rng2.getProvider().getClass().getSimpleName())) {
