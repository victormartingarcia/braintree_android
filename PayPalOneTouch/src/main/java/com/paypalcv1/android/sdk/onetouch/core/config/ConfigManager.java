package com.paypalcv1.android.sdk.onetouch.core.config;

import com.braintreecv1payments.api.interfaces.HttpResponseCallback;
import com.paypalcv1.android.sdk.onetouch.core.BuildConfig;
import com.paypalcv1.android.sdk.onetouch.core.base.ContextInspector;
import com.paypalcv1.android.sdk.onetouch.core.network.PayPalHttpClient;
...
public class ConfigManager {
    ...
    private static final String PREFERENCES_CONFIG_FILE = "com.paypalcv1.otc.config.file";
    private static final String PREFERENCES_LAST_UPDATED = "com.paypalcv1.otc.config.lastUpdated.timestamp";
    private static final String PREFERENCES_CONFIG_IS_DEFAULT = "com.paypalcv1.otc.config.isDefault";
