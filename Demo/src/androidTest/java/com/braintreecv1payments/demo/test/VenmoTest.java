...
import static com.braintreecv1payments.demo.test.utilities.AppInstallationHelper.isAppInstalled;
...
public class VenmoTest extends TestHelper {
    ...
    public void tokenizesVenmo() {
        ...
        onDevice(withResourceId("com.braintreecv1payments.demo:id/nonce"))
