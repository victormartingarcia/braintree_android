...
import com.braintreecv1payments.api.internal.SignatureVerificationOverrides;
import com.braintreecv1payments.api.models.BinData;
...
import com.braintreecv1payments.demo.models.ClientToken;
...
public abstract class BaseActivity extends AppCompatActivity implements OnRequestPermissionsResultCallback,
    ...
    private static final String EXTRA_AUTHORIZATION = "com.braintreecv1payments.demo.EXTRA_AUTHORIZATION";
    private static final String EXTRA_CUSTOMER_ID = "com.braintreecv1payments.demo.EXTRA_CUSTOMER_ID";
