...
public interface UnionPayListener extends BraintreeListener {
    ...
    /**
     * Will be called when
     * {@link com.braintreecv1payments.api.models.UnionPayCapabilities} has been successfully fetched.
     */
     ...
     * {@link com.braintreecv1payments.api.UnionPay#enroll(BraintreeFragment, UnionPayCardBuilder)}.
     * This SMS code will need to be supplied in the {@link UnionPayCardBuilder} when calling
     * {@link com.braintreecv1payments.api.UnionPay#tokenize(BraintreeFragment, UnionPayCardBuilder)}.
