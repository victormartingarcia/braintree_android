...
import com.braintreecv1payments.api.exceptions.AppSwitchNotAvailableException;
...
import com.braintreecv1payments.api.models.MetadataBuilder;
import com.braintreecv1payments.api.models.PaymentMethodNonce;
import com.braintreecv1payments.api.models.VenmoAccountBuilder;
import com.braintreecv1payments.api.models.VenmoAccountNonce;
import com.braintreecv1payments.api.models.VenmoConfiguration;
...
public class Venmo {
    ...
    private static final String VAULT_VENMO_KEY = "com.braintreecv1payments.api.Venmo.VAULT_VENMO_KEY";

    private static final String META_KEY = "_meta";

    static final String EXTRA_MERCHANT_ID = "com.braintreecv1payments.api.MERCHANT_ID";
    static final String EXTRA_ACCESS_TOKEN = "com.braintreecv1payments.api.ACCESS_TOKEN";
    static final String EXTRA_ENVIRONMENT = "com.braintreecv1payments.api.ENVIRONMENT";
    static final String EXTRA_BRAINTREE_DATA = "com.braintreecv1payments.api.EXTRA_BRAINTREE_DATA";
    static final String EXTRA_PAYMENT_METHOD_NONCE = "com.braintreecv1payments.api.EXTRA_PAYMENT_METHOD_NONCE";
    static final String EXTRA_USERNAME = "com.braintreecv1payments.api.EXTRA_USER_NAME";
     ...
     * com.braintreecv1payments.api.interfaces.BraintreeErrorListener#onError(Exception)}.
     *
