...
import com.braintreecv1payments.api.models.UnionPayCardBuilder;
import com.braintreecv1payments.api.models.UnionPayConfiguration;
...
public class UnionPay {
     ...
     * {@link com.braintreecv1payments.api.interfaces.UnionPayListener#onCapabilitiesFetched(UnionPayCapabilities)}
     * <p/>
     * On error, an exception will be passed back to
     * {@link com.braintreecv1payments.api.interfaces.BraintreeErrorListener#onError(Exception)}
     *
     ...
     * {@link com.braintreecv1payments.api.interfaces.UnionPayListener#onSmsCodeSent(String, boolean)}
    ...
    /**
     * Create a {@link com.braintreecv1payments.api.models.CardNonce}. Note that if the card is a UnionPay card,
     ...
     * <p/>
     * On completion, returns the {@link com.braintreecv1payments.api.models.PaymentMethodNonce} to {@link
     * com.braintreecv1payments.api.interfaces.PaymentMethodNonceCreatedListener}.
     * <p/>
     * If creation fails validation, {@link com.braintreecv1payments.api.interfaces.BraintreeErrorListener#onError(Exception)}
     * will be called with the resulting {@link com.braintreecv1payments.api.exceptions.ErrorWithResponse}.
     * <p/>
     * If an error not due to validation (server error, network issue, etc.) occurs, {@link
     * com.braintreecv1payments.api.interfaces.BraintreeErrorListener#onError(Exception)} will be called with the {@link
